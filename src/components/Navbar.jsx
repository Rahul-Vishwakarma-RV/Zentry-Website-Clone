...
const Navbar = () => {
  ...
  return (
      <div ref={navContainerRef} className="fixed inset-x-0 top-2 z-50 h-16  border-none transition-all duration-700 sm:inset-x-6 lg:inset-x-4">
    <header className="absolute  top-1/7 w-full -translate-y-1/2">
